...
All the environments are registered in the `Project_Favuzzi_Mutasci` extension. They start
...
def main():
    """Print all environments registered in `Project_Favuzzi_Mutasci` extension."""
